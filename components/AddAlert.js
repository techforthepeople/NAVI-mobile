        ...
        return (
            <View style={{ marginTop: 50 }}>
                ...
                >
                    ...
                    <View style={{ marginTop: 50 }}>
                    <Button title="Cancel" onPress={() => {this.props.handleSumbit(this.state)}} />
